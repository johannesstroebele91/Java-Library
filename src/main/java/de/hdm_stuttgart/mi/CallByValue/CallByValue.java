...
public class CallByValue {
    ...
    public CallByValue(int a){
        this.a = a;
    }

    // Edit actual obj -> change IS reflected afterwards
    public void changeObj (CallByValue obj){
         ...
         *  thereby the change persists even after the method
         * in call by value
         */
    }

    // Edit reference -> change ISN'T reflected afterwards
    public void changeReference (CallByValue obj){
        System.out.println("\tBefore (within method): " + obj.a);
        obj = new CallByValue(30);   // Reference on the stack is changed
